...
function AuditTab() {
  ...
  return (
    <div>
      <div className="bg-white rounded-lg shadow p-3 mb-3 flex flex-wrap gap-3">
...
function EvModelsTab() {
  ...
  return (
    <div>
      <div className="bg-white rounded-lg shadow p-3 mb-3 flex flex-wrap gap-2 items-end">
...
function ForceMergeTab() {
  ...
  return (
    <form onSubmit={go} className="bg-white rounded-lg shadow p-4 max-w-xl">
