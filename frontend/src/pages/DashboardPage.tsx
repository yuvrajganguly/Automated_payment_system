      ...
      <TableShell>
        <thead className="text-left border-b border-edge-soft">
          <tr>
            ...
            <SortableTh tag="prior_dues_collected" sortKey={sortKey} sortDir={sortDir} onClick={toggleSort} right>Prior dues collected</SortableTh>
            <SortableTh tag="carried_forward" sortKey={sortKey} sortDir={sortDir} onClick={toggleSort} right>Carried forward</SortableTh>
        ...
        <tfoot>
          <tr className="border-t border-edge text-slate-900 font-semibold bg-white/[0.02]">
            ...
            <td className={cell}>{r0(sorted.reduce((a, r) => a + r.carried_forward, 0))}</td>
